...
app = FastAPI(title="Resume Builder API", description="API for creating and updating resumes using LangChain")
...
# API endpoints
@app.post("/resume/create", response_model=ResumeResponse)
...
@app.post("/resume/update", response_model=ResumeResponse)
